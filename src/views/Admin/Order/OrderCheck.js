  ...
  const renderContent = () => {
    ...
    return (
      <Table
        ...
        tableHead={["Mã vận đơn", "Tên sản phẩm", "Giá (RMB)", "Giá (VNĐ)", "Ngày tạo đơn", "Trạng thái"]}
    ...
    if (orders.data && orders.data.length) {
      return (
        <div className="pagination">
          <Pagination count={orders.last_page} color="primary" page={conditions.page} onChange={(event, value) => changePage(event, value)}/>
        </div>
      )
    }
    return null
